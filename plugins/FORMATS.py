...
<blockquote expandable>➪ I ᴀᴍ ᴀ TᴇʀᴀBᴏx Dᴏᴡɴʟᴏᴀᴅ Bᴏᴛ, ᴄʀᴇᴀᴛᴇᴅ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴅᴏᴡɴʟᴏᴀᴅ ғɪʟᴇs ғʀᴏᴍ TᴇʀᴀBᴏx ᴀɴᴅ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴅɪʀᴇᴄᴛ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ.

➪ Iɴ ᴏʀᴅᴇʀ ᴛᴏ ᴜsᴇ ᴍʏ sᴇʀᴠɪᴄᴇs, ʏᴏᴜ ᴍᴜsᴛ ғᴏʟʟᴏᴡ ᴀʟʟ ᴛʜᴇ ᴍᴇɴᴛɪᴏɴᴇᴅ ᴄʜᴀɴɴᴇʟs ᴛʜᴀᴛ ᴀʀᴇ ʀᴇǫᴜɪʀᴇᴅ ғᴏʀ ᴀᴄᴄᴇss.

➪ Jᴜsᴛ sᴇɴᴅ ᴀ ᴠᴀʟɪᴅ TᴇʀᴀBᴏx ʟɪɴᴋ, ᴀɴᴅ ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ ᴀ ᴅɪʀᴇᴄᴛ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ ᴏʀ ғɪʟᴇ ғᴏʀ ᴇᴀsʏ ᴀᴄᴄᴇss.
...
🧑‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ: @rohithinte thandha </b></blockquote>"""
...
◈ ʙᴜᴛᴛᴏɴ 1 Lɪɴᴋ: {link}
◈ ʙᴜᴛᴛᴏɴ 2 Nᴀᴍᴇ: {name2}
◈ ʙᴜᴛᴛᴏɴ 2 Lɪɴᴋ: {link2}</blockquote>
